...
<head>
    ...
    <style>
        ...
        @keyframes pulse-glow {
            0%, 100% { opacity: 1; filter: drop-shadow(0 0 15px rgba(34, 211, 238, 0.3)); }
            50% { opacity: 0.8; filter: drop-shadow(0 0 25px rgba(34, 211, 238, 0.5)); }
        }
...
<header id="navbar" class="fixed top-0 left-0 right-0 z-50 py-6 transition-all duration-500">
    <nav class="max-w-7xl mx-auto px-6">
        <div class="glass rounded-3xl px-8 py-4">
...
<section class="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
    ...
    <div class="relative z-10 text-center px-6 max-w-6xl mx-auto">
        ...
        <h1 class="reveal text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter mb-10 leading-[0.9]">
            <span class="inline-block hover:skew-y-2 transition-transform duration-300">Helooo</span>
            <br/>
            <span class="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 gradient-animate">Nice to meet you</span>
        </h1>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="reveal glass p-10 rounded-3xl group cursor-pointer">
                ...
                <p class="text-gray-500 text-sm mb-6">Vue js HTML CSS</p>
                <div class="relative">
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 items-center gap-12 pt-12 border-t border-white/5">
            ...
            <div class="flex justify-center gap-6">
                ...
                <a href="#" class="w-12 h-12 rounded-full glass flex items-center justify-center hover:bg-white/10 transition-all group" aria-label="LinkedIn">
                    <i data-lucide="linkedin" class="w-5 h-5 group-hover:scale-110 transition-transform"></i>
                </a>
                <a href="#" class="w-12 h-12 rounded-full glass flex items-center justify-center hover:bg-white/10 transition-all group" aria-label="Twitter">
...
{{--                <div class="text-gray-600 text-sm mb-2">© 2026 All Rights Reserved</div>--}}
                <div class="text-gray-700 text-xs">Designed & Built in Lopsang 🇳🇵</div>
            </div>
        </div>
    </div>
</footer>
...
<script>
    ...
    new Typed('#typewriter', {
        strings: ['modern web applications', 'scalable architectures', 'seamless user experiences', 'high-performance systems'],
        typeSpeed: 60,
        backSpeed: 40,
        backDelay: 2000,
        loop: true
    ...
    window.addEventListener('scroll', () => {
        ...
        if(window.scrollY > 100) {
            nav.classList.add('bg-black/80', 'backdrop-blur-2xl', 'shadow-2xl', 'py-4');
            nav.classList.remove('py-6');
        } else {
            nav.classList.remove('bg-black/80', 'backdrop-blur-2xl', 'shadow-2xl', 'py-4');
